"""
This file shows the tutorial screen before the game starts.
It displays the control keys and waits for the player
to press Enter or Space to begin.
"""
...
def show_tutorial_overlay(snapshot):
    """Display the tutorial overlay and wait for user input."""
