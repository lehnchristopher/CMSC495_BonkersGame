    ...
    for powerup in powerups[:]:
        if bar.colliderect(powerup.rect):
            ...
            if powerup.type == "blast":
                ...
                # Turn off other powerups when getting fireball
                blast_active = False
                blast_timer = 0
                paddle_state = "normal"
                paddle_state_timer = 0
            ...
            # Play sound for powerup collection
            if coin_sound:
                coin_sound.play()
